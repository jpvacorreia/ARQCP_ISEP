...
cube:
	...
	movl  %ecx, %eax # saves the number passed as parameter on EAX
	imull %ecx, %eax # multiply by the number from the params
	imull %ecx, %eax # multiply by the number from the params again
